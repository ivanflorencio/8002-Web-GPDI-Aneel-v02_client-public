...
export const MeuCadastroRoute: Route = {
  ...
  canActivate: ["logged"],
  loadChildren: () =>
    import("@app/pages/meu-cadastro/meu-cadastro.module").then(
      (m) => m.MeuCadastroModule
    ),
};
...
export const ProjetosRoute: Route = {
  path: "projetos",
  loadChildren: () =>
    import("@app/pages/projetos/projetos.module").then((m) => m.ProjetosModule),
};
...
export const ConfiguracaoRoute: Route = {
  ...
  loadChildren: () =>
    import("@app/pages/configuracoes/configuracoes-sistema.module").then(
      (m) => m.ConfiguracoesSistemaModule
    ),
};
...
export const GestaoPeDRoute: Route = {
  ...
  component: SidebarComponent,
  loadChildren: () =>
    import("@app/pages/gestao-ped/gestao-ped.module").then(
      (m) => m.GestaoPeDModule
    ),
};
...
export const GerenciarUsuariosRoute: Route = {
  ...
  loadChildren: () =>
    import("@app/pages/gerenciar-usuarios/gerenciar-usuarios.module").then(
      (m) => m.GerenciarUsuariosModule
    ),
};
export const DemandasRoute: Route = {
  path: "demandas",
  loadChildren: () =>
    import("@app/pages/demandas/demandas.module").then((m) => m.DemandasModule),
};
export const CaptacoesRoute: Route = {
  path: "captacoes",
  component: SidebarComponent,
  loadChildren: () =>
    import("@app/pages/captacao/captacao.module").then((m) => m.CaptacaoModule),
};
...
export const PropostaSelecaoRoute: Route = {
  ...
  component: SidebarComponent,
  loadChildren: () =>
    import("@app/pages/propostas/selecao/propostas-selecao.module").then(
      (m) => m.PropostasSelecaoModule
    ),
};
export const PropostaRefinamentoRoute: Route = {
  ...
  loadChildren: () =>
    import(
      "@app/pages/propostas/refinamento/propostas-refinamento.module"
...
export const PropostaFormalizacaoRoute: Route = {
  ...
  loadChildren: () =>
    import(
      "@app/pages/propostas/formalizacao/propostas-formalizacao.module"
...
export const PropostaRiscosRoute: Route = {
  ...
  loadChildren: () =>
    import(
      "@app/pages/propostas/identificacao-riscos/propostas-identificacao-riscos.module"
...
const AdminRoutes: Routes = [
  {
    ...
    loadChildren: () =>
      import("@app/users-modules/admin/admin.module").then(
        (m) => m.AdminModule
      ),
  },
];
const GestorRoutes: Routes = [
  {
    ...
    loadChildren: () =>
      import("@app/users-modules/gestor/gestor.module").then(
        (m) => m.GestorModule
      ),
  },
];
const ColaboradorRoutes: Routes = [
  {
    ...
    loadChildren: () =>
      import("@app/users-modules/colaborador/colaborador.module").then(
...
const SuprimentoRoutes: Routes = [
  {
    ...
    loadChildren: () =>
      import("@app/users-modules/suprimento/suprimento.module").then(
...
const FornecedorRoutes: Routes = [
  {
    ...
    loadChildren: () =>
      import("@app/users-modules/fornecedor/fornecedor.module").then(
