...
export const Roles: Array<TextValue> = [
    ...
    { text: 'AnalistaPed', value: UserRole.AnalistaPed },
...
export const Atividades: Array<TextValue> = [
    ...
    {
        text:
            'Participação dos membros da equipe de gestão em eventos sobre pesquisa, desenvolvimento e inovação relacionados ao ' +
            'setor elétrico e/ou em cursos de gestão tecnológica e da informação. ',
        value: 'EC',
    },
    {
        text: 'Desenvolvimento de ferramenta para gestão do Programa de PDI da Empresa, excluindose aquisição de equipamentos.',
        value: 'FG',
    },
    {
        text:
            'Prospecção tecnológica e demais atividades necessárias ao planejamento e' +
