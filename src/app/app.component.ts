...
export class AppEntranceComponent implements OnInit {
    constructor(protected auth: AuthService, private app: AppService, protected route: ActivatedRoute, protected router: Router) {}
