                    ...
                    behavior.next([
                        {
                            ...
                            path: 'pendente',
                            role: [UserRole.Administrador, UserRole.User],
                        },
                        {
                        ...
                        {
                            text: `Captação Aberta`,
                            afterText: t(Fornecedor),
                            path: 'aberta',
                            role: [UserRole.Administrador, UserRole.User],
                        },
                        {
                            text: `Captação Encerrada`,
                            afterText: t(Encerrada),
                            path: 'encerrada',
                            role: [UserRole.Administrador, UserRole.User],
                        },
                        {
                            text: `Captação Cancelada`,
                            afterText: t(Cancelada),
                            path: 'cancelada',
                            role: [UserRole.Administrador, UserRole.User],
                        },
                    ]);
