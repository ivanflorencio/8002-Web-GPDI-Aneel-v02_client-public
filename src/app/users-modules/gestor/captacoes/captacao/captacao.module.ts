...
@NgModule({
    ...
    imports: [SharedModule, ComponentsModule, DashboardModule, CaptacaoRoutingModule],
    providers: [PropostaDetalhesResolver, ContratoPadraoResolver, PropostasResolver, ContratosPadroesResolver, FornecedoresResolver],
})
