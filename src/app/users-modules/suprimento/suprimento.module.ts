...
@NgModule({
    declarations: [],
    imports: [CommonModule, DashboardModule, SuprimentoRoutingModule],
    providers: [
        CaptacoesService,
        CaptacaoResolver,
        CaptacoesResolver,
        {
            ...
            useValue: [{ subtitle: 'Suprimentos', text: 'Captação de Propostas', icon: 'ta-extrato', path: '/suprimentos/captacoes' }],
        },
        {
            provide: HEADER_MENU,
