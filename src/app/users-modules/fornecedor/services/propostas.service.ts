...
export class PropostasService extends ServiceBase<any> {
    ...
    async aceitarCondicoes(id: number) {
        return await this.http
            .post<any>(`${this.controller}/${id}/Condicoes`, {
    ...
    async getContratoRevisao(captacaoId: number, id: number) {
        return await this.http.get<Array<BaseEntity>>(`${this.controller}/${captacaoId}/Contrato/Revisoes/${id}`, {}).toPromise();
    }

    async getContratoRevisaoDiff(captacaoId: number, id: number) {
        return await this.http.get(`${this.controller}/${captacaoId}/Contrato/Revisoes/${id}/Diff`, { responseType: 'text' }).toPromise();
    }
    ...
    async downloadArquivo(captacaoId: number, file) {
        const blob = await this.http
            .get(`${this.controller}/Arquivos/${file.id}`, {
                responseType: 'blob',
            })
            .toPromise();
